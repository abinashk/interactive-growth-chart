...
function redraw() {
    ...
    legendEnter.append('text')
        ...
        .text(function(d){ return d.name.split("_")[0].capitalizeFirstLetter(); });
    ...
    function mousemove() {
        ...
        d3.select("#tooltipTitle").html("Goal By Today:  " + (currencyType(data.goal_growth[1].value * Math.round(x0) / Math.round(x.invert(width)))));
